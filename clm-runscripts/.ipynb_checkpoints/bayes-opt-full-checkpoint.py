...
logger = JSONLogger(path="/glade/u/home/marielj/clm_frost/clm-runscripts/logs/clm_logs_stream.json", reset = False)
...
'''RUN OPTIMIZATION'''
clm_optimizer.maximize(init_points = 0, n_iter = 61,
