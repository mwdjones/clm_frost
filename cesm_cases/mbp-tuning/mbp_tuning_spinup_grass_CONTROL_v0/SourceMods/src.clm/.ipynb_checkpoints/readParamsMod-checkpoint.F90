...
contains
  ...
  subroutine readParameters (nutrient_competition_method, photosyns_inst)
    ...
    !added by MWJones 3/15/2023
    use initVerticalMod                   , only : readParams_initVerticalMod             => readParams
    !use SoilHydrologyMod                 , only : readParams_SoilHydrologyMod            => readParams
    ...
    call readParams_initVerticalMod( ncid ) ! added MWJones 3/15/2023
    !call readParams_SoilHydrologyMod( ncid ) ! added MWJones 3/15/2023
