...
#include "shr_assert.h"
  ...
  public :: initVertical
  public :: readParams !MWJONES - Added 3/15/2023
  
  type, private :: params_type
     real(r8) :: slopebeta  ! Surface microtopography slope exponent (unitless)
     real(r8) :: slopemax  ! Maximum value of surface microtopography slope (unitless)
...
contains
  ...
  subroutine readParams( ncid )
    ...
    !
    ! !LOCAL VARIABLES:
    character(len=*), parameter :: subname = 'readParams_initVerticalMod'
  ...
  subroutine initVertical(bounds, glc_behavior, snow_depth, thick_wall, thick_roof)
    ...
    do c = begc,endc
       ...
       slopebeta = params_inst%slopebeta !- MWJONES 3/15/2023
       slopemax = params_inst%slopemax !- MWJONES 3/15/2023
